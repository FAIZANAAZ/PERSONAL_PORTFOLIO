...
export default function Component() {
  return (
    <section className=" z-10 flex flex-col lg:pt-15 md:flex-row  in-h-[calc(100vh-50px)] w-[100%] gap-20  px-4 sm:px-6 md:px-8 lg:px-[8rem] justify-between lg:p-[5rem]">
      <div className="flex flex-col gap-y-2 md:gap-y-4 mb-8 md:mb-0 text-center md:text-left">
        <h5 className="text-[1rem] sm:text-[2rem] font-bold text-white">
          Hey !
        </h5>
        ...
        <Link href="/static_resume" className="inline-block">
          <button
      ...
      <div className="lg:pl-20 relative flex justify-center md:justify-end">
